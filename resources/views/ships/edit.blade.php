...
@section('page-title', 'Edit Ship')
@section('breadcrumb', 'NavalForge / Ships / Edit')
@section('content')
...
<div style="margin-bottom:1.5rem;">
    ...
    <h1 style="font-size:22px;font-weight:700;color:#0f172a;">Edit ship</h1>
</div>
...
<div style="max-width:680px;">
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:2rem;">
        ...
        <form method="POST" action="{{ route('ships.update', $ship->ship_id) }}">
            @csrf
            @method('PATCH')
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
                <div>
                    ...
                    <input type="text" name="ship_name" value="{{ old('ship_name', $ship->ship_name) }}"
                ...
                <div>
                    ...
                    <input type="text" name="ship_type" value="{{ old('ship_type', $ship->ship_type) }}"
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
                <div>
                    ...
                    <input type="text" name="owner_name" value="{{ old('owner_name', $ship->owner_name) }}"
                ...
                <div>
                    ...
                    <input type="text" name="flag_country" value="{{ old('flag_country', $ship->flag_country) }}"
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
                ...
                <div>
                    ...
                    <input type="date" name="arrival_date" value="{{ old('arrival_date', $ship->arrival_date) }}"
                           style="width:100%;font-size:13px;padding:9px 12px;border:1.5px solid #e2e8f0;border-radius:8px;outline:none;color:#0f172a;">
                </div>
            </div>
            ...
            <div style="margin-bottom:24px;">
                ...
                <div style="font-size:11px;color:#64748b;margin-bottom:10px;">
                    Changing to <strong>Departed</strong> will automatically free the ship's berth.
                </div>
                <div style="display:flex;gap:10px;">
                    ...
                    @php $currentStatus = old('status', $ship->status); @endphp
                    <label style="flex:1;cursor:pointer;">
                        <input type="radio" name="status" value="{{ $val }}"
                               {{ $currentStatus === $val ? 'checked' : '' }}
                               style="display:none;" class="status-radio">
                        <div class="status-card" data-val="{{ $val }}"
                             style="padding:12px;border:2px solid {{ $currentStatus === $val ? '#2563eb' : '#e2e8f0' }};border-radius:8px;text-align:center;background:{{ $currentStatus === $val ? '#eff6ff' : '#fff' }};transition:all .15s;">
